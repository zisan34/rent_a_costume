                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-hover mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/images/users/user-2.jpg')}}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/images/users/user-3.jpg')}}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/images/users/user-1.jpg')}}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/images/users/user-4.jpg')}}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/images/users/user-5.jpg')}}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
