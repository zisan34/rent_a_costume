            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="{{url('admin/ecommerce-product-edit')}}">Product Edit</a>
                        </li>
                        <li>
                            <a href="{{url('admin/ecommerce-orders')}}">Orders</a>
                        </li>
                        <li>
                            <a href="{{url('admin/ecommerce-sellers')}}">Sellers</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="admin-animation">Animation</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="admin-loading-buttons">Loading Buttons</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="icons-themify">Themify</a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="forms-image-crop">Image Crop</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="tables-bootstrap">Bootstrap Tables</a>
                        </li>
                        <li>
                            <a href="tables-tablesaw">Tablesaw Tables</a>
                        </li>
                        <li>
                            <a href="tables-jsgrid">JsGrid Tables</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="charts-ricksaw">Ricksaw Charts</a>
                        </li>
                        <li>
                            <a href="charts-just-gage">JustGage Charts</a>
                        </li>
                    </ul>
                </li>
